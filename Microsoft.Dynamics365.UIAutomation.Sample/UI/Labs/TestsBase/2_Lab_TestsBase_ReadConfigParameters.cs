...
namespace Microsoft.Dynamics365.UIAutomation.Sample
{
    ...
    public class Lab_TestsBase_ReadConfigParameters : TestsBase {
        ...
        public void UseTheBaseClass()
        {
            ...
            options.PerformanceMode = false; // <= you can also change other settings here
            ...
            using (var xrmApp = new XrmApp(client))
            {
                ...
                xrmApp.Navigation.OpenApp(AppName.Sales); // <= change this parameters to navigate to another app
        ...
        public void UseTheBaseClass_GoToCases_InCustomerServicesApp()
        {
           ...
           // options.PrivateMode = false; // <= this test is not in private mode, ignore config
            ...
            using (var xrmApp = new XrmApp(client))
            {
                ...
                xrmApp.Navigation.OpenApp(AppName.CustomerService); // <= navigate to another app
